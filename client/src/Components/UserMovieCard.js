    ...
    <div className='w-60 p-2 bg-black rounded-xl sm:w-60 '>
        ...
        {isClicked
          ? <form onSubmit={handleSubmit}>
              <input className=" text-center rounded-lg ml-1 mt-1 p-1 bg-gray-700 focus:border-blue-500 focus:bg-gray-800 focus:outline-none" type='text' name='comment' placeholder='Edit comment' value={editedComment} onChange={handleChange}></input>
              {[...Array(5)].map((star, i) => {
